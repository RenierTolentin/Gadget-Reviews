...
const EntryLevel_Xiaomi = () => {
    ...
    useEffect(() => {
        Axios.get(`http://localhost:3001/EntryLevel_Xiaomi/${id}`)
            .then((response)=>{
...
export default EntryLevel_Xiaomi;