...
const MidRange_Motorola = () => {
    ...
    useEffect(() => {
        Axios.get(`http://localhost:3001/MidRange_Motorola/${id}`)
            .then((response)=>{
    ...
    return ( 
        <section className="brand-group">
            <Link to="../MidRange">
                <h1><img src="/SVG/motorola.svg" alt="motorola"/> Phones</h1>
            </Link> 
...
export default MidRange_Motorola;