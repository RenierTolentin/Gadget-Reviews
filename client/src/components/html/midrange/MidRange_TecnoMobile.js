...
const MidRange_TecnoMobile = () => {
    ...
    useEffect(() => {
        Axios.get(`http://localhost:3001/MidRange_Infinix/${id}`)
            .then((response)=>{
...
export default MidRange_TecnoMobile;